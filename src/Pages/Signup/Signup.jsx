        ...
        <div>
            <div className="">
                <div className="max-w-5xl mx-auto backdrop-blur-sm bg-white/30 items-center text-center p-20">
                    ...
                    <p className="text-sm font-serif mb-6">Stay with FoodGarden</p>
                    <form className="max-w-sm mx-auto">
                    <div className="relative mb-4">
                            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                <FaRegUserCircle className="text-xl"></FaRegUserCircle>
                            </div>
                            <input type="email" id="email-address-icon" className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-white dark:border-gray-600 dark:placeholder-black  dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="user Name" />
                        </div>
                        <div className="relative mb-4">
                            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                        ...
                        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 w-full mt-6 font-serif me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign up</button>
                    </form>
                    <div className="mt-">
                        <h1 className="text-base font-serif">Already have an account? <Link to={'/login'}>
                            <span className="text-base font-serif text-blue-600">Login</span>
                        </Link>
                        </h1>
                    </div>
                    <div>
